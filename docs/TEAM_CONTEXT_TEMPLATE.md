# AI Git Assistant Team Context Template

Copy this file to `.ai-git-assistant/team-context.md` in a repository, then edit it to match the team. Keep it practical, specific, and free of secrets.
